        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown <?php if($page=='about') {echo 'active';} ?>">
                    <a class="nav-link dropdown-toggle <?php if($page=='about') {echo 'active';} ?>" href="#"
            ...
            <li><a class="dropdown-item" href="#">Something else here</a></li> -->
                ...
                <li class="nav-item dropdown <?php if($page=='links') {echo 'active';} ?>">
                    <a class="nav-link dropdown-toggle <?php if($page=='links') {echo 'active';} ?>" href="#" id="linksDropdown" role="button"
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php if($page=='dashboard') {echo 'active';} ?>" href="#"
